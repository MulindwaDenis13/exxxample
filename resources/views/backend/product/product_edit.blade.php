...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
  ...
  <form method="post" action="{{ route('product-update') }}" >
	...
	<h5>Brand Select <span class="">*</span></h5>
	<div class="controls">
 ...
 <option value="{{ $category->id }}" {{ $category->id == $products->category_id ? 'selected': '' }} >{{ $category->category_name_en }}</option>
	 ...
	 @enderror
			...
			<div class="col-md-4">
				 ...
				 <div class="form-group">
	<h5>SubCategory Select <span class="">*</span></h5>
	<div class="controls">
...
<div class="row"> <!-- start 2nd row  -->
	 ...
	 <div class="form-group">
	<h5>SubSubCategory Select <span class="">*</span></h5>
	<div class="controls">
  ...
  <input type="text" name="product_code" class="form-control" required="" value="{{ $products->product_code }}">
	 ...
	 @enderror
			...
			<div class="col-md-6">
				 ...
				 <div class="form-group">
			<h5>Product Quantity <span class="">*</span></h5>
			<div class="controls">
	 <input type="number" name="product_qty" class="form-control" value="{{ $products->product_qty }}">
     @error('product_qty')
	 <span class="text-danger">{{ $message }}</span>
	 @enderror
	 	  </div>
			...
			<div class="col-md-6">
				 ...
				 <div class="form-group">
			<h5>Product Tags<span class="">*</span></h5>
			<div class="controls">
...
<div class="row"> <!-- start 4th row  -->
	 ...
	 @enderror
			...
			<div class="col-md-4">
				 ...
				 <div class="form-group">
			<h5>Product Size<span class="">*</span></h5>
			<div class="controls">
...
<div class="row"> <!-- start 5th row  -->
	    ...
	    <div class="form-group">
			<h5>Product Color<span class="">*</span></h5>
			<div class="controls">
...
<div class="row"> <!-- start 6th row  -->
	...
	<div class="col-md-6">
	   	...
	   	<div class="form-group">
			...
			<div class="controls">
  <input type="number" name="selling_price" class="form-control" required="" value="{{ $products->selling_price }}">
     @error('selling_price')
	 <span class="text-danger">{{ $message }}</span>
	 @enderror
	 	  </div>
	    ...
	    <div class="form-group">
			...
			<div class="controls">
	 <input type="number" name="discount_price" class="form-control" value="{{ $products->discount_price }}">
...
<div class="row"> <!-- start 7th row  -->
	    ...
	    <div class="form-group">
			<h5>Short Description English <span class="">*</span></h5>
			<div class="controls">
	<textarea name="short_descp_en" id="textarea" class="form-control" placeholder="Textarea text">
...
<div class="row"> <!-- start 8th row  -->
	    ...
	    <div class="form-group">
			<h5>Long Description English <span class="">*</span></h5>
			<div class="controls">
