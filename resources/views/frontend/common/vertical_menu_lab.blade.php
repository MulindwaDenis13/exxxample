...
$categories = App\Models\Category::where('identifier', 'Laboratory')->orderBy('category_name_en','ASC')->get();
@endphp


 <div class="side-menu animate-dropdown outer-bottom-xs">
          <div class="head"><i class="icon fa fa-align-justify fa-fw"></i>Lab Categories</div>
